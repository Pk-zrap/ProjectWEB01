...
import Logo from '../../assets/snapedit_1710048841449-Photoroom.png-Photoroom.png';


function Barbelow() {
    return (
        <div>
            <footer className="footer p-10 text-info"style={{background: '#f1f5f9'}}>
                <aside>
                    <img
                        src={Logo}
                    ...
                    />
                    <p>The Memory Makers.<br />Provide reliable service</p>
                </aside>
                <nav>
                ...
                <nav>
                    <h1 className="footer-title">Privacy</h1>
                ...
                <form>
                    <h6 className="footer-title">สมัครรับข่าวอัปเดตจากเรา</h6>
